        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="index.html"><i class="fa fa-dashboard "></i>QUẢN LÝ KHO</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-desktop "></i>Nhập hàng</a>
                        
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-plus "></i>Xem kho hàng</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-plus "></i>Xuất hàng</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-comments-o "></i>Danh sách đơn hàng</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-comments-o "></i>Đơn hàng chưa xử lý</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-comments-o "></i>Đơn hàng đang xử lý</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-comments-o "></i>Đơn hàng xử lý thành công</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-comments-o "></i>Đơn hàng xử lý thất bại</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-comments-o "></i>Tìm đơn hàng</a>
                    </li>
                    <li>
